...
namespace TestHarness
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var list = new ListBox(dialog) { Top = 10, Left = 4, Width = 26, Height = 6, Border = BorderStyle.Thin };
            var line = new VerticalLine(dialog) { Top = 4, Left = 31, Width = 1, Height = 6, Border = BorderStyle.Thick };
            ...
            new Label(dialog) { Text = "Test of TextBoxes!", Top = 2, Left = 34 };

            var mLine = new MultiLineTextbox(dialog);
            mLine.Width = 20;
            mLine.Height = 12;
            mLine.Top = 4;
            mLine.Left = 34;
